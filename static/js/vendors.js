...
/******/ 	var hotCurrentHash = "64e72b16cf7fdcfe8823"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports) {
	 ...
	 * 鐢ㄤ簬瀹炵幇鍩烘湰鐨� ajax 鍔熻兘
	 *
	 * 浣跨敤 Promise 瀹炵幇 ajax 鐨勫熀鏈姛鑳斤紝POST 鎻愪氦鏂瑰紡涓鸿〃鍗曟彁浜わ紝
	 * 浣跨敤 Promise.then(func) 鍜� Promise.catch(func) 鏉ヨ缃洖璋冨嚱鏁�
	 *
	 * @param  {string}  url     API 鍦板潃
	 * @param  {string}  method  璁块棶 API 鏂瑰紡锛圙ET || POST锛�
	 * @param  {object}  data    浼犺緭鏁版嵁
	 * @returns  Promise
	 * @returns 鎴愬姛鏃� resolve 杩斿洖鑾峰彇鍒扮殑鏁版嵁
	 * @returns 澶辫触鏃� reject 杩斿洖涓€涓璞★紝鍖呭惈 xhr 鍜� status
	 *
	 * @date     2016-06-01
